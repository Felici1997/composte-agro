...
const badges = [
  {
    ...
    desc: 'Comptes professionnels authentifiés manuellement',
    color: 'text-blue-600',
    bg: 'bg-blue-50',
  },
  {
    ...
    desc: 'Transactions protégées via notre plateforme',
  ...
  },
  {
    ...
    desc: 'Annulation gratuite sous 48h avant livraison',
