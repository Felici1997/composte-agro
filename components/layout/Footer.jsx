    ...
    <footer className="bg-slate-900 text-slate-300 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <span className="text-lg font-semibold text-white">agri<span className="text-agrishop-400">shop</span></span>
            </Link>
          ...
          {/* Links */}
          <div>
            <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-3">AgriShop</h3>
            <ul className="space-y-2">
              <li><Link href="/help" className="text-sm text-slate-400 hover:text-agrishop-400 transition">Aide</Link></li>
              <li><Link href="/about" className="text-sm text-slate-400 hover:text-agrishop-400 transition">À propos</Link></li>
              <li><Link href="/contact" className="text-sm text-slate-400 hover:text-agrishop-400 transition">Contact</Link></li>
              <li><Link href="/legal" className="text-sm text-slate-400 hover:text-agrishop-400 transition">CGU & Confidentialité</Link></li>
            </ul>
        ...
        <div className="border-t border-slate-800 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
          <p>&copy; {new Date().getFullYear()} AgriShop. Tous droits réservés.</p>
